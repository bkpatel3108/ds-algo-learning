...
public class BinaryTreeVectorImplTest {
	...
	public static void main(String[] args) {
		...
		// test depth
		System.out.println("tree.depth(node4) >> " + T.depth(node4));
		System.out.println("tree.depth(node11) >> " + T.depth(node11));
		System.out.println("tree.depth(node1) >> " + T.depth(node1));

		// test height
		System.out.println("tree.height(node1) >> " + T.height(node1));
