...
public class BinaryTreeVectorImpl<T> implements BinaryTree<T> {
	 ...
	 * @return value of left child of the node which is at position nodePosition
	 */
	...
	/**
	 * Creates a new right child of Node which is at position nodePosition,and
	 * storing new node value as nodeValue; returns its Position.
	 * 
	 * @param nodePosition
	...
	/**
	 * Checks a node, which is at position nodePosition, is internal to tree or
	 * not
	 * 
	 * @param nodePosition
	...
	/**
	 * Checks a node, which is at position nodePosition, is external to tree or
	 * not
	 * 
	 * @param nodePosition
	 *            -> position of node which needs to be checked whether it is
	...
	/**
	 * Checks a node, which is at position nodePosition, is root of tree or not
	 * 
	 * @param nodePosition
	 *            -> position of node which needs to be checked whether it is
	 *            root of tree or not
	 ...
	 *            count
	 * @return no of leaves of tree which has "@param nodePosition" as position
	 *         of root node
	 */
	 ...
	 *            count
	 * @return no of arcs in tree which has "@param nodePosition" as position of
	 *         root node
	 */
	 ...
	 *            count
	 * @return no of nodes of tree which has "@param nodePosition" as position
	 *         of root node
	 */
	 ...
	 *            want to count
	 * @return no of internal nodes of tree which has "@param nodePosition" as
	 ...
	 *            calculate
	 * @return depth of tree which has "@param nodePosition" as position of root
	 *         node
	 */
	public Integer depth(Integer nodePosition) {
		if (!isRoot(nodePosition)) {
			Integer parentNodePos = parentNodePosition(nodePosition);
			return 1 + depth(parentNodePos);
		} else
			return 0;
	}

	/**
	 * Returns height of the tree whose root node position is nodePosition
	 * 
	 * @param nodePosition
	 *            -> position of root node of tree whose height we want to
	 *            calculate
	 * @return height of tree which has "@param nodePosition" as position of
	 *         root node
	 */
	public Integer height(Integer nodePosition) {
		if (isInternal(nodePosition)) {
			Integer heightOfLeftChild;
			Integer heightOfRightChild;
			Integer leftChildPos = left(nodePosition);
			Integer rightChildPos = right(nodePosition);

			if (leftChildPos != null)
				heightOfLeftChild = height(leftChildPos);
			else
				heightOfLeftChild = 0;

			if (rightChildPos != null)
				heightOfRightChild = height(rightChildPos);
			else
				heightOfRightChild = 0;

			return 1 + (heightOfLeftChild > heightOfRightChild ? heightOfLeftChild : heightOfRightChild);
		} else
			return 0;
	}
	...
	/**
	 * Returns a position of parent of the node which is at position
	 * nodePosition
	 * 
	 * @param nodePosition
	 *            -> position of Node whose parent's position we want to get
	 * @return position of parent of the node which is at position nodePosition
	 */
	public Integer parentNodePosition(Integer nodePosition) {
		if (nodePosition >= 1) {
