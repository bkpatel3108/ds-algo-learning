...
public class FirstClassPassengerFactory extends PassengerAbstractFactory {

	Integer avgArrivalRate;
	Integer avgServiceTime;

	FirstClassPassengerFactory(Integer avgArrivalRate, Integer avgServiceTime) {
	...
	public Passenger getFirstClassPassenger() {
		...
		if (isNewPassenger == true) {
			...
			return new Passenger(passengerServiceTime, "FIRST_CLASS");
		}
		return null;
	}
